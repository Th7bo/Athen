...
enum class InfernoDrops(
    ...
    GLOWSTONE_DUST_DISTILLATE("Glowstone dust distillate", Items.PLAYER_HEAD, SlayerDropGrade.RARE, SlayerDropChance(null, 840, 4.6952, SlayerDropTable.MAIN), display2 = "Glowstone distillate"),
    ...
    NETHER_STALK_DISTILLATE("Nether stalk distillate", Items.PLAYER_HEAD, SlayerDropGrade.RARE, SlayerDropChance(null, 840, 4.6952, SlayerDropTable.MAIN), display2 = "Nether wart distillate"),
    ...
    ENCHANTMENT_ULTIMATE_REITERATE("Duplex I", Items.ENCHANTED_BOOK, SlayerDropGrade.RARE, SlayerDropChance(23_220, 350, 2.1533, SlayerDropTable.MAIN), SlayerDropParserType.ENCHANT, "duplex:1", "Enchanted Book (Duplex I)"),
