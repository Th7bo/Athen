...
enum class RevenantDrops(
    ...
    PESTILENCE_RUNE("Pestilence I", Items.PLAYER_HEAD, SlayerDropGrade.RARE, SlayerDropChance(7_977, 833, 6.2679, SlayerDropTable.EXTRA), SlayerDropParserType.TEXTURE, ""),
    ...
    ENCHANTMENT_SMITE("Smite VI", Items.ENCHANTED_BOOK, SlayerDropGrade.EXTRAORDINARY, SlayerDropChance(124_370, 50, 0.402, SlayerDropTable.MAIN), SlayerDropParserType.ENCHANT, "smite:6", "Enchanted Book (Smite VI)"),
    ...
    SHARD_OF_THE_SHREDDED("Shredded sinew", Items.PLAYER_HEAD, SlayerDropGrade.PRAY_RNGESUS, SlayerDropChance(918_562, 8, 0.1021, SlayerDropTable.MAIN)),
