...
enum class VoidgloomDrops(
    ...
    ENCHANTMENT_MANA_STEAL("Mana steal I", Items.ENCHANTED_BOOK, SlayerDropGrade.RARE, SlayerDropChance(11_183, 600, 4.4709, SlayerDropTable.MAIN), SlayerDropParserType.ENCHANT, "mana_steal:1", "Enchanted Book (Mana Steal I)"),
    ...
    EXCEEDINGLY_RARE_ENDER_ARTIFACT_UPGRADE("Ender artifact upgrade", Items.PLAYER_HEAD, SlayerDropGrade.RNGESUS_INCARNATE, SlayerDropChance(1_771_125, 4, 0.0282, SlayerDropTable.MAIN), display2 = "Exceedingly rare ender artifact upgrade"),
    ...
    ENCHANT_RUNE("Enchant rune I", Items.PLAYER_HEAD, SlayerDropGrade.PRAY_RNGESUS, SlayerDropChance(1_078_642, 7, 0.0464, SlayerDropTable.EXTRA), SlayerDropParserType.TEXTURE, ""),
